...
<body>
    ...
    <center>
        <form class="formulario mx-5 p-3 my-3 bg-dark" action="" method="POST" style="border-radius: 13px;">
            <h1 class="text-light">Contate-nos!</h1>
            <div class="input-group mb-3">
                <input class="form-control" type="text" name="mensagem" id="mensagem" placeholder="Escreva sua mensagem aqui" aria-label="Mensagem">
            </div>
